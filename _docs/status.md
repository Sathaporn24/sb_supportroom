...
|---|---|---|
| knowledge-base | **requirement ครบแล้ว** — R1–R6 เคาะครบ 2026-08-19 | **system-analyst** (ออกแบบ data model + `design.md`) |
...
**Next**: `system-analyst` ออกแบบ data model จาก `requirement.md` — จุดที่ต้องคิดหนัก: ตาราง
หมวด 2 ระดับต่อบริษัท · namespace ระดับหมวดใน Pinecone (วันนี้มี 2 ระดับ) · ตาราง Q&A พร้อม
scope ที่ CS เลือกได้ · คิวงานที่ทนต่อ restart · `IKnowledgeIndexProvider` ต้องเพิ่มการลบทีละชุด
(วันนี้มีแค่ลบทั้ง namespace) · **และต้องตอบว่าข้อมูลเดิมที่ยังไม่มีหมวดจะ migrate อย่างไร**
