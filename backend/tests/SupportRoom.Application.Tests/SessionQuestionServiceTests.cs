...
public class SessionQuestionServiceTests
{
    ...
    public SessionQuestionServiceTests()
    {
        ...
        _service = new SessionQuestionService(_unitOfWork, new FakeServiceProvider(), NullLogger<ISessionQuestionService>.Instance);
    }
    ...
    [Fact]
    public void GetBySessionId_ReturnsQuestionsOldestFirst()
    {
        SeedSession("session-1");
        _questions.Items.Add(new SessionQuestion { Id = "q-late", SessionId = "session-1", AnswerStatus = AnswerStatus.Answered, CreateDate = new DateTime(2026, 1, 2, 0, 0, 0, DateTimeKind.Utc) });
        _questions.Items.Add(new SessionQuestion { Id = "q-early", SessionId = "session-1", AnswerStatus = AnswerStatus.NotFound, CreateDate = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) });
        _questions.Items.Add(new SessionQuestion { Id = "q-other", SessionId = "session-2", AnswerStatus = AnswerStatus.Answered, CreateDate = new DateTime(2026, 1, 3, 0, 0, 0, DateTimeKind.Utc) });
