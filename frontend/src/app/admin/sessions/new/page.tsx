  ...
  return (
    <main className="mx-auto flex max-w-4xl flex-col gap-6 p-6">
      <div>
        ...
        <h1 className="mt-1 text-xl font-semibold">สร้างลิงก์การสอน</h1>
        <p className="mt-1 text-sm text-muted-foreground">เลือกสื่อการสอนที่ต้องการสร้างลิงก์ห้องสอนให้ผู้ใช้</p>
      </div>
